...
namespace PupBase
{
    [BepInPlugin("PeeksCustomPups.PupBase", "CustomManyPups", "1.2.10")]
    internal class Plugin : BaseUnityPlugin
    {
        ...
        private void RainWorld_OnModsInit(On.RainWorld.orig_OnModsInit orig, global::RainWorld self)
        {
            ...
            try
            {
                ...
                if (!isInit)
                {
                    ...
                    bool flag = global::ModManager.ActiveMods.Any((global::ModManager.Mod mod) => mod.id == "PeeksCustomPups.PupBase");
                    if (flag)
                    {
                        Plugin.PupBaseInit();
                    }
        ...
        public const string MOD_ID = "PeeksCustomPups.PupBase";

            public static readonly bool LogOutPut = true;

            public const string MOD_NAME = "CustomManyPups";

            public const string VERSION = "1.1.8";

            public const string AUTHORS = "pikafan1343445";
